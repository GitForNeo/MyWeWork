...
static void _logos_method$_ungrouped$WWKConversationRedEnvelopesBubbleView$tony_onClickHongbaoMessage(_LOGOS_SELF_TYPE_NORMAL WWKConversationRedEnvelopesBubbleView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    
    WWKMessageRedEnvelopes *redEnvelopes = [self.message.messageItems firstObject];
    ...
    _logos_orig$_ungrouped$WWKConversationRedEnvelopesBubbleView$tony_onClickHongbaoMessage(self, _cmd);
}
